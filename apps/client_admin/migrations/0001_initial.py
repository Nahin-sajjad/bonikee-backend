# Generated by Django 4.2.1 on 2023-09-27 10:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("admin", models.JSONField(blank=True, null=True)),
                ("product", models.JSONField(blank=True, null=True)),
                ("invoice", models.JSONField(blank=True, null=True)),
                ("purchase", models.JSONField(blank=True, null=True)),
                ("finance", models.JSONField(blank=True, null=True)),
                (
                    "created_by",
                    models.ForeignKey(
                        blank=True,
